...
*/
    ...
    public void ParkArm(){
        ...
        rh.intakeArm.setPower(1);
        while (opModeIsActive() && rh.intakeArm.getCurrentPosition() > 50) {
        }
